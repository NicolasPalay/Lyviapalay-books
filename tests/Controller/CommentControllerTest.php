...
class CommentControllerTest extends WebTestCase
{
    ...
    public function testNew(): void
    {
        ...
        $this->client->submitForm('Save', [
            ...
            'comment[active]' => 'Testing',
            'comment[rgpt]' => 'Testing',
            'comment[blog]' => 'Testing',
    ...
    public function testShow(): void
    {
        ...
        $fixture->setRgpt('My Title');
        $fixture->setBlog('My Title');
    ...
    public function testEdit(): void
    {
        ...
        $this->client->submitForm('Update', [
            ...
            'comment[active]' => 'Something New',
            'comment[rgpt]' => 'Something New',
            'comment[blog]' => 'Something New',
        ...
        self::assertSame('Something New', $fixture[0]->getRgpt());
        self::assertSame('Something New', $fixture[0]->getBlog());
